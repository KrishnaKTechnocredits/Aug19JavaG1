/*Find first differed index from an unsorted array using scanner class*/

package loopExamples;
import java.util.Scanner;

public class ScannerArrayProblem8 {
	void printfirstdifferedindex(int input1[],int input2[])
	{
		...
		if(flag==0)
			System.out.println("Arrays do not differ.");
	}
	public static void main(String[] args) {
		...
		ScannerArrayProblem8 arrayproblem8 = new ScannerArrayProblem8();
		arrayproblem8.printfirstdifferedindex(a,b);
	}
}
