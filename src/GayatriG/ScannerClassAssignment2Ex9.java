...
public class ScannerClassAssignment2Ex9 {
	...
	public static void main(String[] args) {
		...
		ScannerClassAssignment2Ex9 scannerclassassignment2ex9 = new ScannerClassAssignment2Ex9();
		scannerclassassignment2ex9.differIndex(arr1, arr2);
	}
}
